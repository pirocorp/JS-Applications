import { deleteBook, getBooks, html, until } from './utilities.js';
...
async function loadBooks(ctx) {
    ...
    return books.map(book => bookRow(book, toggleEditor.bind(null, book, ctx), onDelete.bind(null, book._id, ctx)));
}
